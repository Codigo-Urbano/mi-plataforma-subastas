        ...
        <div className="fixed inset-0 bg-background/90 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-card w-full max-w-5xl rounded-xl shadow-2xl border border-border flex flex-col max-h-[90vh]">
            <div className="p-4 border-b border-border flex justify-between items-center bg-muted/30">
              <h3 className="font-bold text-lg">Revisión KYC: {seleccionado.nombre_completo || seleccionado.email}</h3>
            ...
            <div className="p-6 overflow-y-auto flex-1">
              <div className="bg-amber-500/10 border border-amber-500/30 text-amber-600 p-4 rounded-lg mb-6 text-sm">
                <strong>Precaución de Seguridad:</strong> Comprueba visualmente que el rostro en la selfie coincida exactamente con la fotografía del documento de identidad. Verifica que los documentos sean legibles y no presenten signos de alteración digital.
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col">
                  <h4 className="font-semibold text-sm mb-3 text-center uppercase tracking-wider text-muted-foreground">Fotografía Selfie</h4>
...
`;
fs.writeFileSync("src/app/admin/PanelKYC.tsx", content, "utf8");
