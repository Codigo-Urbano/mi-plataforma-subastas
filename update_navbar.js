            ...
            {user ? (
              <div className="flex items-center gap-4">
                ...
                {isAdmin && (
                  <Link
                    href="/admin"
                    className="text-sm font-medium bg-red-500/10 text-red-500 border border-red-500/20 px-3 py-1.5 rounded-md hover:bg-red-500/20 transition-colors flex items-center gap-1.5"
                  >
                    Panel Admin
                  </Link>
                )}
